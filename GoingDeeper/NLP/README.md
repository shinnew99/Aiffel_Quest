...
|GD3|7|워드 임베딩 <br>Word Embeddings | 워드 임베딩 벡터(Word2Vec, FastText, Glove)의 원리와 사용법을 학습 <br>Learning the principles and usage of word embedding vectors (Word2Vec, FastText, Glove)|
|GD3|8&9|WEAT | [PROJECT] WEAT(Word Embedding Association Test) 기법으로, Word Embedding Model 의 편향성 측정 <br>Measuring the bias of Word Embedding Models using the WEAT (Word Embedding Association Test) technique|
...
|GD09|23&24|16|HuggingFace 커스텀 프로젝트 만들기 <br>Creating a Custom Project with Hugging Face | Huggingface transformer를 활용한 커스텀 프로젝트 수행 <br>Performing a custom project using Hugging Face Transformer|
|GD09|26|#NLP Trend Note 1 | 최신 LLM 소개, InstructGPT의 SFT, RM, PPO 학습 메커니즘 소개 <br>ntroduction to the latest LLM, introduction to the training mechanisms of InstructGPT's SFT, RM, PPO|
|GD09|27|#NLP Trend Note 2 <br> | KochatGPT 구현 <br>Implementation of KochatGPT|
